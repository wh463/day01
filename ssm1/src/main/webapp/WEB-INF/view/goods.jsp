...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="date" name="createtime1" class="form-control" id="txt_search_createtime1" >
			      <input type="date" name="createtime2" class="form-control" id="txt_search_createtime2" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">商品分类</span>
					<select class="form-control" name="txt_search_id" id = "txt_search_id">
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_import" method="post" action="importGoods.htm" enctype="multipart/form-date">
						
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							
							<tr>
								<td>请选择：</td>
								<td><input type="file" id="goodsFile" name="goodsFile"
									class="form-control" aria-required="true" required/></td>
							</tr>
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            createtime1: $("#txt_search_createtime1").val(),
	            createtime2: $("#txt_search_createtime2").val(),
	            typeid: $("#txt_search_id").val(),
